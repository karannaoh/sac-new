...
<div class="tabbable"> <!-- Only required for left/right tabs -->
  ...
  <!--<div class="row" >
    ...
    <li class="active"><a href="#tab1" data-toggle="tab"><div class="for1">Class Gift of 2015</div></a></li>
    <li ><a href="#tab2" data-toggle="tab"><div class="for1">Mentorship</div></a></li>
    <li><a href="#tab3" data-toggle="tab"><div class="for1">Guest Lecture</div></a></li>
    <li><a href="#tab4" data-toggle="tab"><div class="for1">Yearbook 2016</div></a></li>
  </ul>
